...
public abstract class ExpNode {
    ...
    /**
     * Node for an element of an array
     */
    public static class ArrayIndexNode extends ExpNode {
        /**
         * Name of the identifier
         */
        private ExpNode id;
        ...
        public ArrayIndexNode(Location loc, ExpNode id, ExpNode index) {
            super(loc);
            this.id = id;
            this.index = index;
        }
        ...
        @Override
        public String toString() {
            return "ArrayIndexNode(" + id + "[" + index + "])";
        }
    }
