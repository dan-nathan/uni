...
public abstract class ExpNode {
    ...
    /**
     * Node representing a set constructor
     */
    public static class SetNode extends ExpNode {

        // The elements to initialise with
        private List<ExpNode> elements;

        public SetNode(Location loc, List<ExpNode> elements, Type type) {
            super(loc, type);
            this.elements = elements;
        }

        public SetNode(Location loc, Type type) {
            this(loc, new ArrayList<>(), type);
        }
        ...
        @Override
        public String toString() {
            StringBuilder builder = new StringBuilder("SetNode(");
            Iterator<ExpNode> elemsIter = elements.iterator();
            while (elemsIter.hasNext()) {
                builder.append(elemsIter.next().toString());
