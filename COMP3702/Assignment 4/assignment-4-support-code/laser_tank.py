...
class LaserTankMap:
    ...
    def __init__(self, params):
        ...
        #print("Move cost: " + str(self.__move_cost))
        #print("Collision cost: " + str(self.__collision_cost))
        #print("Game over cost: " + str(self.__game_over_cost))
        #print("Goal reward: " + str(self.__goal_reward))
        #print("Success prob: " + str(self.__t_success_prob))
