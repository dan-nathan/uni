...
public class Network {
     ...
     * given list are null, none of them should be added. If any of the stops in
     * the given list already exist in the network, a DuplicateStopException
     * should be thrown
     * @param stops
     * @throws DuplicateStopException
     */
    public void addStops(List<Stop> stops) throws DuplicateStopException {
        // Check every stop first before adding any
        for (Stop stop : stops) {
            if (stop == null) {
                return;
            }
