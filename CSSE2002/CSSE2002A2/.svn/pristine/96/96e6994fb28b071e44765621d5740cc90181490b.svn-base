...
public class Ferry extends PublicTransport {
     ...
     * where {ferryType} is replaced by the type of this ferry, and all of the
     * other components are the same as defined in the method being overridden.
     * For example:
     * ferry,2,50,2,CityCat
     * Specified by encode in interface Writeable
     * Overrides encode in class PublicTransport
